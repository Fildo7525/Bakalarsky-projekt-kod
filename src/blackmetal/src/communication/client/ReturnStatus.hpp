...
/**
 * @brief Get the string representation of the @c bm::Command code.
 *
...
/**
 * @enum Status
 * @brief Status returned by the server.
 *
 * The robot receives the json string and returns a json string with a specific return status.
 * This status is than mapped on @c BlackMetal::Status enum type.
 */
enum class Status {
...
/**
 * @brief Get the string representation of the @c bm::Status code.
 *
